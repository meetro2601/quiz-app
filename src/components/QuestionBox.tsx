...
function QuestionBox({question,answers,quesNum,totalQuestions,userAns,callback}:Props) {
    return (
        <div className='col-lg-6 col-md-8 col-sm-10 col-12 mx-auto quesBox'>
            <h6 className='pb-2'>Question : {quesNum} / {totalQuestions}</h6>
            <div>
                        ...
                        answers.map((answer,index)=>{
                            return (
                                <BtnDiv
                                 ...
                                 key={index} >
                                <button className='btn my-2 w-100' value={answer} dangerouslySetInnerHTML={{__html:answer}} onClick={callback}></button>
                                </BtnDiv>
                            )
                        })
                    }
